...
namespace Caso01
{
    public partial class frmLlamdasConValorRetornoSinParametro : Form
    {
        public frmLlamdasConValorRetornoSinParametro()
        {
            InitializeComponent();
            tHora.Enabled = true;
        }
        ...
        private void frmLlamdasConValorRetornoSinParametro_Load(object sender, EventArgs e)
        {
        ...
        //Asignación de costo por minuto segun el tipo
